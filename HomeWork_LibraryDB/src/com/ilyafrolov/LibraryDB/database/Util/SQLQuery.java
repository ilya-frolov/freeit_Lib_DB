...
public class SQLQuery {
    ...
    public static final String GET_BOOK_BY_TITLE = "select * from books where title = ?";
    ...
    public static final String GET_FROM_AUTHORS_BY_NAME = "select * from authors where name = ?";
    public static final String GET_FROM_GENRES_BY_NAME = "select * from genres where name = ?";
